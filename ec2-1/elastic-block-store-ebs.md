...
*   여러개의 EBS 볼륨을 생성하여 하나의 EC2 에 추가 연결 가능
    ...
    * 하나만 생성하는 게 아니라 볼륨을 여러개 생성해서 하나의 EC2에 연결할 수 있다.
    ...
    <figure><img src="../.gitbook/assets/image (2).png" alt="" width="291"><figcaption><p> 하나만 생성하는 게 아니라 볼륨을 여러개 생성해서 하나의 EC2에 연결할 수 있다.</p></figcaption></figure>
...
*   특정한 조건 아래서 하나의 EBS 볼륨이 여러개의 EC2인스턴스와 동시에 연결할 수 있는 기능이다.
    ...
    <figure><img src="../.gitbook/assets/image (4).png" alt="" width="375"><figcaption><p> 하나의 EBS 볼륨이 여러개의 EC2인스턴스와 동시에 연결</p></figcaption></figure>
