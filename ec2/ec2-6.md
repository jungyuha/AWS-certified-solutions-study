...
<figure><img src="../.gitbook/assets/image (10).png" alt="" width="563"><figcaption><p> 프로그램이 종료되지 않고 그대로 남아있는 모습</p></figcaption></figure>

### 인스턴스 종료하기

#### 오른쪽 상단 '작업' > '인스턴스 설정' > '종료 방지 기능 변경' > 종료방지 활성화의 체크를 해제 > 인스턴스 종료

<figure><img src="../.gitbook/assets/image (31).png" alt=""><figcaption><p> 인스턴스 종료</p></figcaption></figure>

#### 왼쪽 메뉴 '네트워크 및 보안' > 탄력적 IP > 탄력적 IP 주소 릴리스&#x20;

<figure><img src="../.gitbook/assets/image (20).png" alt=""><figcaption><p> 탄력적 IP 주소 삭제</p></figcaption></figure>
